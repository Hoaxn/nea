...
final exceededHoursRemoteDataSourceProvider =
    Provider<ExceededHoursRemoteDataSource>(
  (ref) {
    return ExceededHoursRemoteDataSource(
...
class ExceededHoursRemoteDataSource {
  final Dio dio;
  final UserSharedPrefs userSharedPrefs;

  ExceededHoursRemoteDataSource(this.dio, this.userSharedPrefs);
